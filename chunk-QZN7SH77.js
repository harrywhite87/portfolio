import{a as ke,b as Xe}from"./chunk-TQELINQH.js";import{a as He,b as We}from"./chunk-RTXFIVLE.js";import{a as Ve}from"./chunk-SWOLF7KG.js";import{a as ve,b as Ce,c as Ue,d as Ge,e as xe}from"./chunk-YXM3ADHT.js";import{a as Be}from"./chunk-WIAJ462U.js";import{a as ye}from"./chunk-B6UU5HEQ.js";import{b as De}from"./chunk-L5DS73E3.js";import{b as _e}from"./chunk-CNG2D76X.js";import{b as Fe}from"./chunk-3A6RKXCW.js";import{b as Pe}from"./chunk-GOFXFHZZ.js";import{b as be}from"./chunk-AF6BMQVD.js";import{b as Ae}from"./chunk-ZQTNFS6T.js";import{a as Ie}from"./chunk-OGVMVK75.js";import{b as Oe}from"./chunk-XDZY3UBG.js";import{b as Le}from"./chunk-N75RMTED.js";import{b as Te}from"./chunk-4NPYFG24.js";import{b as ge}from"./chunk-HG3VIM4J.js";import{b as Me}from"./chunk-U6SP5MFS.js";import{a as Ne,c as he}from"./chunk-NQYMMSFS.js";import{a as pe}from"./chunk-UH3UEMT2.js";import{a as ue}from"./chunk-QKJPKFVP.js";import{b as Re}from"./chunk-JDF3M24H.js";import{a as e,b as i}from"./chunk-SS6WXUSY.js";import{d as r}from"./chunk-4ZZIO3ZI.js";var n,we,f=r(()=>{"use strict";i();pe();n="pbrFragmentExtraDeclaration",we=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=we)});var t,Ye,o=r(()=>{"use strict";i();t="samplerFragmentAlternateDeclaration",Ye=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=Ye)});var c,ze,l=r(()=>{"use strict";i();Ne();o();c="pbrFragmentSamplersDeclaration",ze=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=ze)});var d,Ke,s=r(()=>{"use strict";i();d="subSurfaceScatteringFunctions",Ke=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=Ke)});var E,qe,m=r(()=>{"use strict";i();E="pbrHelperFunctions",qe=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=qe)});var S,Ze,R=r(()=>{"use strict";i();Ie();S="pbrDirectLightingSetupFunctions",Ze=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=Ze)});var p,Je,u=r(()=>{"use strict";i();p="pbrDirectLightingFalloffFunctions",Je=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Je)});var v,je,C=r(()=>{"use strict";i();v="pbrDirectLightingFunctions",je=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=je)});var A,Qe,I=r(()=>{"use strict";i();A="pbrIBLFunctions",Qe=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=Qe)});var O,$e,N=r(()=>{"use strict";i();Ue();O="pbrBlockAlbedoOpacity",$e=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=$e)});var L,er,T=r(()=>{"use strict";i();L="pbrBlockReflectivity",er=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=er)});var g,rr,M=r(()=>{"use strict";i();g="pbrBlockAmbientOcclusion",rr=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=rr)});var h,ir,D=r(()=>{"use strict";i();h="pbrBlockAlphaFresnel",ir=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=ir)});var _,ar,F=r(()=>{"use strict";i();_="pbrBlockAnisotropic",ar=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=ar)});var P,nr,U=r(()=>{"use strict";i();P="pbrBlockReflection",nr=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=nr)});var G,fr,b=r(()=>{"use strict";i();G="pbrBlockSheen",fr=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=fr)});var B,tr,y=r(()=>{"use strict";i();B="pbrBlockClearcoat",tr=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=tr)});var x,or,V=r(()=>{"use strict";i();x="pbrBlockIridescence",or=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=or)});var H,cr,W=r(()=>{"use strict";i();H="pbrBlockSubSurface",cr=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=cr)});var k,lr,X=r(()=>{"use strict";i();k="pbrBlockNormalGeometric",lr=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=lr)});var w,dr,Y=r(()=>{"use strict";i();w="pbrBlockNormalFinal",dr=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=dr)});var z,sr,K=r(()=>{"use strict";i();z="pbrBlockLightmapInit",sr=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=sr)});var q,Er,Z=r(()=>{"use strict";i();q="pbrBlockGeometryInfo",Er=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=mr)});var Q,Sr,$=r(()=>{"use strict";i();Q="pbrBlockReflectance",Sr=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[Q]||(e.IncludesShadersStoreWGSL[Q]=Sr)});var ee,Rr,re=r(()=>{"use strict";i();ee="pbrBlockDirectLighting",Rr=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStoreWGSL[ee]||(e.IncludesShadersStoreWGSL[ee]=Rr)});var ie,pr,ae=r(()=>{"use strict";i();ie="pbrBlockFinalLitComponents",pr=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[ie]||(e.IncludesShadersStoreWGSL[ie]=pr)});var ne,ur,fe=r(()=>{"use strict";i();ne="pbrBlockFinalUnlitComponents",ur=`var finalDiffuse: vec3f=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStoreWGSL[ne]||(e.IncludesShadersStoreWGSL[ne]=ur)});var te,vr,oe=r(()=>{"use strict";i();te="pbrBlockFinalColorComposition",vr=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[te]||(e.IncludesShadersStoreWGSL[te]=vr)});var ce,Cr,le=r(()=>{"use strict";i();ce="pbrBlockImageProcessing",Cr=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[ce]||(e.IncludesShadersStoreWGSL[ce]=Cr)});var de,Ar,se=r(()=>{"use strict";i();de="pbrBlockPrePass",Ar=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;e.IncludesShadersStoreWGSL[de]||(e.IncludesShadersStoreWGSL[de]=Ar)});var Ee,Ir,me=r(()=>{"use strict";i();Ee="pbrDebug",Ir=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[Ee]||(e.IncludesShadersStoreWGSL[Ee]=Ir)});var a,Se,Wa,Or=r(()=>{i();ve();Ce();He();f();Ae();l();Te();De();ue();_e();Re();s();ke();m();ge();Oe();We();R();u();Ve();Xe();C();I();Me();he();Le();N();T();M();D();F();U();b();y();V();W();Fe();X();Pe();Y();Ge();K();Z();j();$();re();be();ae();fe();oe();Be();ye();le();se();xe();me();a="pbrPixelShader",Se=`#define CUSTOM_FRAGMENT_BEGIN
...
`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=Se);Wa={name:a,shader:Se}});export{s as a,Wa as b,Or as c};
