import{a as ce,b as de}from"./chunk-DBVXKFNH.js";import{a as le}from"./chunk-6CGTQFJ6.js";import{a as te,b as oe}from"./chunk-MBO7YWWY.js";import{a as H,b as W,c as ee,d as re,e as fe}from"./chunk-OANGZKKE.js";import{a as ae}from"./chunk-N4GDF6MX.js";import{a as ne}from"./chunk-IYE2BRVS.js";import{b as J}from"./chunk-M2QO3XUK.js";import{b as j}from"./chunk-JTH72UWR.js";import{b as Q}from"./chunk-WMDC7UFR.js";import{b as $}from"./chunk-LMZNDCO3.js";import{b as ie}from"./chunk-4OU3UR5X.js";import{b as k}from"./chunk-W77FFJGA.js";import{b as X}from"./chunk-Y2SMXJ7U.js";import{b as Y}from"./chunk-DXOAMXKA.js";import{b as z}from"./chunk-DOJT4XFM.js";import{b as K}from"./chunk-77OS3P7T.js";import{b as q}from"./chunk-S6UE3FLT.js";import{a as w,c as Z}from"./chunk-7PTN6L46.js";import{a as x}from"./chunk-KMJFGF7Y.js";import{a as V}from"./chunk-5SLLER2Z.js";import{b as y}from"./chunk-2WHHOXUH.js";import{a as e,b as i}from"./chunk-PJTN5MCN.js";import{d as r}from"./chunk-SO6VPFYA.js";var se,Ee,a=r(()=>{"use strict";i();x();se="pbrFragmentExtraDeclaration",Ee=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[se]=Ee});var me,Se,n=r(()=>{"use strict";i();me="samplerFragmentAlternateDeclaration",Se=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[me]=Se});var Re,pe,f=r(()=>{"use strict";i();w();n();Re="pbrFragmentSamplersDeclaration",pe=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[Re]=pe});var ve,ue,t=r(()=>{"use strict";i();ve="subSurfaceScatteringFunctions",ue=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[ve]=ue});var Ce,Ae,o=r(()=>{"use strict";i();Ce="pbrHelperFunctions",Ae=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[Ce]=Ae});var Ie,Oe,c=r(()=>{"use strict";i();Ie="pbrDirectLightingSetupFunctions",Oe=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
return result;}`;e.IncludesShadersStoreWGSL[Ie]=Oe});var Ne,Te,l=r(()=>{"use strict";i();Ne="pbrDirectLightingFalloffFunctions",Te=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[Ne]=Te});var Le,Me,d=r(()=>{"use strict";i();Le="pbrDirectLightingFunctions",Me=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[Le]=Me});var ge,De,s=r(()=>{"use strict";i();ge="pbrIBLFunctions",De=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[ge]=De});var _e,he,E=r(()=>{"use strict";i();ee();_e="pbrBlockAlbedoOpacity",he=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[_e]=he});var Fe,Pe,m=r(()=>{"use strict";i();Fe="pbrBlockReflectivity",Pe=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[Fe]=Pe});var Ue,be,S=r(()=>{"use strict";i();Ue="pbrBlockAmbientOcclusion",be=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[Ue]=be});var Be,Ge,R=r(()=>{"use strict";i();Be="pbrBlockAlphaFresnel",Ge=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[Be]=Ge});var ye,xe,p=r(()=>{"use strict";i();ye="pbrBlockAnisotropic",xe=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[ye]=xe});var Ve,He,v=r(()=>{"use strict";i();Ve="pbrBlockReflection",He=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[Ve]=He});var We,ke,u=r(()=>{"use strict";i();We="pbrBlockSheen",ke=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[We]=ke});var Xe,we,C=r(()=>{"use strict";i();Xe="pbrBlockClearcoat",we=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[Xe]=we});var Ye,ze,A=r(()=>{"use strict";i();Ye="pbrBlockIridescence",ze=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[Ye]=ze});var Ke,qe,I=r(()=>{"use strict";i();Ke="pbrBlockSubSurface",qe=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[Ke]=qe});var Ze,Je,O=r(()=>{"use strict";i();Ze="pbrBlockNormalGeometric",Je=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[Ze]=Je});var je,Qe,N=r(()=>{"use strict";i();je="pbrBlockNormalFinal",Qe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[je]=Qe});var $e,er,T=r(()=>{"use strict";i();$e="pbrBlockLightmapInit",er=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[$e]=er});var rr,ir,L=r(()=>{"use strict";i();rr="pbrBlockGeometryInfo",ir=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;e.IncludesShadersStoreWGSL[ar]=nr});var fr,tr,g=r(()=>{"use strict";i();fr="pbrBlockReflectance",tr=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[fr]=tr});var or,cr,D=r(()=>{"use strict";i();or="pbrBlockDirectLighting",cr=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStoreWGSL[or]=cr});var lr,dr,_=r(()=>{"use strict";i();lr="pbrBlockFinalLitComponents",dr=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[lr]=dr});var sr,Er,h=r(()=>{"use strict";i();sr="pbrBlockFinalUnlitComponents",Er=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,vec3f(0.0));finalDiffuse*=uniforms.vLightingIntensity.x;var finalAmbient: vec3f=uniforms.vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;var finalEmissive: vec3f=uniforms.vEmissiveColor;
#ifdef EMISSIVE
...
`;e.IncludesShadersStoreWGSL[sr]=Er});var mr,Sr,F=r(()=>{"use strict";i();mr="pbrBlockFinalColorComposition",Sr=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[mr]=Sr});var Rr,pr,P=r(()=>{"use strict";i();Rr="pbrBlockImageProcessing",pr=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[Rr]=pr});var vr,ur,U=r(()=>{"use strict";i();vr="pbrBlockPrePass",ur=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;e.IncludesShadersStoreWGSL[vr]=ur});var Cr,Ar,b=r(()=>{"use strict";i();Cr="pbrDebug",Ar=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[Cr]=Ar});var B,G,Va,Ir=r(()=>{i();H();W();te();a();k();f();z();J();V();j();y();t();ce();o();K();X();oe();c();l();le();de();d();s();q();Z();Y();E();m();S();R();p();v();u();C();A();I();Q();O();$();N();re();T();L();M();g();D();ie();_();h();F();ae();ne();P();U();fe();b();B="pbrPixelShader",G=`#define CUSTOM_FRAGMENT_BEGIN
...
`;e.ShadersStoreWGSL[B]=G;Va={name:B,shader:G}});export{Va as a,Ir as b};
