import{a as e,b as r}from"./chunk-PJTN5MCN.js";import{d as a}from"./chunk-SO6VPFYA.js";var o,v,c,i=a(()=>{r();o="fxaaVertexShader",v=`attribute vec2 position;uniform vec2 texelSize;varying vec2 vUV;varying vec2 sampleCoordS;varying vec2 sampleCoordE;varying vec2 sampleCoordN;varying vec2 sampleCoordW;varying vec2 sampleCoordNW;varying vec2 sampleCoordSE;varying vec2 sampleCoordNE;varying vec2 sampleCoordSW;const vec2 madd=vec2(0.5,0.5);
...
}`;e.ShadersStore[o]=v;c={name:o,shader:v}});export{c as a,i as b};
