import{a as se,b as Re}from"./chunk-U2MMTLBS.js";import{a as Ee}from"./chunk-FGRGX3BA.js";import{a as le,b as de}from"./chunk-EYRJ6PIE.js";import{a as W,b as X,c as k,d as ae,e as re,f as ce}from"./chunk-3WBUC2VN.js";import{a as te}from"./chunk-ZKAVBVS4.js";import{a as fe}from"./chunk-ZEU6R3GF.js";import{b as J}from"./chunk-66GN6STB.js";import{b as j}from"./chunk-2NLUUHCI.js";import{a as K,c as Q}from"./chunk-5HHHJW7Q.js";import{b as $}from"./chunk-J4HULUOK.js";import{b as ee}from"./chunk-KQNTIX7Y.js";import{b as ie}from"./chunk-VEMZTVVL.js";import{b as ne}from"./chunk-NHKRXAW5.js";import{b as oe}from"./chunk-KUEUMZYO.js";import{a as H}from"./chunk-T5TEK7BR.js";import{a as x}from"./chunk-POT6QY66.js";import{b as Y}from"./chunk-XMQ2BSYJ.js";import{b as w}from"./chunk-LJZ776JU.js";import{b as z}from"./chunk-MSF6CVDM.js";import{b as q}from"./chunk-ZIHOSEHM.js";import{b as Z}from"./chunk-KZMMENIX.js";import{b as V}from"./chunk-MO66LBYJ.js";import{a as e,b as n}from"./chunk-PJTN5MCN.js";import{d as i}from"./chunk-SO6VPFYA.js";var Ce,me,a=i(()=>{"use strict";n();W();Ce="pbrFragmentDeclaration",me=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[Ce]=me});var Ae,Se,r=i(()=>{"use strict";n();H();Ae="pbrFragmentExtraDeclaration",Se=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[Ae]=Se});var ue,Ie,o=i(()=>{"use strict";n();ue="samplerFragmentAlternateDeclaration",Ie=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[ue]=Ie});var ve,Oe,t=i(()=>{"use strict";n();K();o();ve="pbrFragmentSamplersDeclaration",Oe=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[ve]=Oe});var pe,Ne,f=i(()=>{"use strict";n();pe="subSurfaceScatteringFunctions",Ne=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[pe]=Ne});var Te,Le,c=i(()=>{"use strict";n();Te="pbrHelperFunctions",Le=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[Te]=Le});var ge,Me,l=i(()=>{"use strict";n();ge="pbrDirectLightingSetupFunctions",Me=`struct preLightingInfo
...
#endif
return result;}`;e.IncludesShadersStore[ge]=Me});var De,_e,d=i(()=>{"use strict";n();De="pbrDirectLightingFalloffFunctions",_e=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[De]=_e});var he,Fe,s=i(()=>{"use strict";n();he="pbrDirectLightingFunctions",Fe=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[he]=Fe});var Pe,be,E=i(()=>{"use strict";n();Pe="pbrIBLFunctions",be=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[Pe]=be});var Ue,Be,R=i(()=>{"use strict";n();ae();Ue="pbrBlockAlbedoOpacity",Be=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[Ue]=Be});var Ge,ye,C=i(()=>{"use strict";n();Ge="pbrBlockReflectivity",ye=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[Ge]=ye});var Ve,He,m=i(()=>{"use strict";n();Ve="pbrBlockAmbientOcclusion",He=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[Ve]=He});var xe,We,A=i(()=>{"use strict";n();xe="pbrBlockAlphaFresnel",We=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[xe]=We});var Xe,ke,S=i(()=>{"use strict";n();Xe="pbrBlockAnisotropic",ke=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[Xe]=ke});var Ye,we,u=i(()=>{"use strict";n();Ye="pbrBlockReflection",we=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[Ye]=we});var ze,Ke,I=i(()=>{"use strict";n();ze="pbrBlockSheen",Ke=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[ze]=Ke});var qe,Ze,v=i(()=>{"use strict";n();qe="pbrBlockClearcoat",Ze=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[qe]=Ze});var Je,je,O=i(()=>{"use strict";n();Je="pbrBlockIridescence",je=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[Je]=je});var Qe,$e,p=i(()=>{"use strict";n();Qe="pbrBlockSubSurface",$e=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[Qe]=$e});var ei,ii,N=i(()=>{"use strict";n();ei="pbrBlockNormalGeometric",ii=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[ei]=ii});var ni,ai,T=i(()=>{"use strict";n();ni="pbrBlockNormalFinal",ai=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[ni]=ai});var ri,oi,L=i(()=>{"use strict";n();ri="pbrBlockLightmapInit",oi=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[ri]=oi});var ti,fi,g=i(()=>{"use strict";n();ti="pbrBlockGeometryInfo",fi=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[ti]=fi});var ci,li,M=i(()=>{"use strict";n();ci="pbrBlockReflectance0",li=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[ci]=li});var di,si,D=i(()=>{"use strict";n();di="pbrBlockReflectance",si=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[di]=si});var Ei,Ri,_=i(()=>{"use strict";n();Ei="pbrBlockDirectLighting",Ri=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[Ei]=Ri});var Ci,mi,h=i(()=>{"use strict";n();Ci="pbrBlockFinalLitComponents",mi=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[Ci]=mi});var Ai,Si,F=i(()=>{"use strict";n();Ai="pbrBlockFinalUnlitComponents",Si=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,0.0);finalDiffuse*=vLightingIntensity.x;vec3 finalAmbient=vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;vec3 finalEmissive=vEmissiveColor;
#ifdef EMISSIVE
...
`;e.IncludesShadersStore[Ai]=Si});var ui,Ii,P=i(()=>{"use strict";n();ui="pbrBlockFinalColorComposition",Ii=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[ui]=Ii});var vi,Oi,b=i(()=>{"use strict";n();vi="pbrBlockImageProcessing",Oi=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[vi]=Oi});var pi,Ni,U=i(()=>{"use strict";n();pi="pbrBlockPrePass",Ni=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[pi]=Ni});var Ti,Li,B=i(()=>{"use strict";n();Ti="pbrDebug",Li=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Ti]=Li});var G,y,Ja,gi=i(()=>{n();X();k();a();le();r();Y();w();t();Z();$();x();ee();V();f();se();c();J();z();de();l();d();Ee();Re();s();E();j();Q();q();R();C();m();A();S();u();I();v();O();p();ie();N();ne();T();re();L();g();M();D();_();oe();h();F();P();te();fe();b();U();ce();B();G="pbrPixelShader",y=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[G]=y;Ja={name:G,shader:y}});export{f as a,Ja as b,gi as c};
