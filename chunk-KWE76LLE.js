import{a as e,b as a}from"./chunk-PJTN5MCN.js";import{d as u}from"./chunk-SO6VPFYA.js";var t,r,S,p=u(()=>{a();t="passCubePixelShader",r=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_cube<f32>;
...
fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,vec3f(uv,-1.001));
#endif
}`;e.ShadersStoreWGSL[t]=r;S={name:t,shader:r}});export{S as a,p as b};
