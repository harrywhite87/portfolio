import{a as ze,b as Ke}from"./chunk-Q4ACAESO.js";import{a as Ye,b as we}from"./chunk-O6NNMKW7.js";import{a as ke}from"./chunk-MUL22ZGX.js";import{a as ve,b as pe,c as Oe,d as ye,e as Ve,f as Xe}from"./chunk-BQGABBYE.js";import{a as xe}from"./chunk-WYE52IHK.js";import{a as We}from"./chunk-DQ5IFYWY.js";import{b as he}from"./chunk-CSD7UQPQ.js";import{b as Fe}from"./chunk-LUO72FLB.js";import{a as De,c as Pe}from"./chunk-MZBH7JXG.js";import{b as be}from"./chunk-O7WTYIII.js";import{b as Ue}from"./chunk-6HTDPGD7.js";import{b as Be}from"./chunk-S6I6UDHN.js";import{b as Ge}from"./chunk-3JJHX3EN.js";import{b as He}from"./chunk-TWA6CGPI.js";import{a as Ae}from"./chunk-3OIUMUQF.js";import{a as Ie}from"./chunk-Y5RP3RSX.js";import{b as Ne}from"./chunk-NLG3ABSE.js";import{b as Te}from"./chunk-F3UIDRI7.js";import{a as Le}from"./chunk-XMQNNDLG.js";import{b as ge}from"./chunk-VP4CPPOC.js";import{b as Me}from"./chunk-D2RBTLH4.js";import{b as _e}from"./chunk-6N5C2HPX.js";import{b as ue}from"./chunk-3GCX4PQ7.js";import{a as e,b as n}from"./chunk-SS6WXUSY.js";import{d as i}from"./chunk-4ZZIO3ZI.js";var r,qe,o=i(()=>{"use strict";n();ve();r="pbrFragmentDeclaration",qe=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=qe)});var t,Ze,f=i(()=>{"use strict";n();Ae();t="pbrFragmentExtraDeclaration",Ze=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=Ze)});var c,Je,l=i(()=>{"use strict";n();c="samplerFragmentAlternateDeclaration",Je=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=Je)});var d,je,s=i(()=>{"use strict";n();De();l();d="pbrFragmentSamplersDeclaration",je=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=je)});var E,Qe,R=i(()=>{"use strict";n();E="subSurfaceScatteringFunctions",Qe=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Qe)});var C,$e,m=i(()=>{"use strict";n();C="pbrHelperFunctions",$e=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=$e)});var S,ei,u=i(()=>{"use strict";n();Le();S="pbrDirectLightingSetupFunctions",ei=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ei)});var A,ii,I=i(()=>{"use strict";n();A="pbrDirectLightingFalloffFunctions",ii=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=ii)});var v,ni,p=i(()=>{"use strict";n();v="pbrDirectLightingFunctions",ni=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=ni)});var O,ai,N=i(()=>{"use strict";n();O="pbrIBLFunctions",ai=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ai)});var T,ri,L=i(()=>{"use strict";n();ye();T="pbrBlockAlbedoOpacity",ri=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=ri)});var g,oi,D=i(()=>{"use strict";n();g="pbrBlockReflectivity",oi=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=oi)});var M,ti,_=i(()=>{"use strict";n();M="pbrBlockAmbientOcclusion",ti=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=ti)});var h,fi,F=i(()=>{"use strict";n();h="pbrBlockAlphaFresnel",fi=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=fi)});var P,ci,b=i(()=>{"use strict";n();P="pbrBlockAnisotropic",ci=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=ci)});var U,li,B=i(()=>{"use strict";n();U="pbrBlockReflection",li=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=li)});var G,di,y=i(()=>{"use strict";n();G="pbrBlockSheen",di=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=di)});var V,si,H=i(()=>{"use strict";n();V="pbrBlockClearcoat",si=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=si)});var x,Ei,W=i(()=>{"use strict";n();x="pbrBlockIridescence",Ei=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=Ei)});var X,Ri,k=i(()=>{"use strict";n();X="pbrBlockSubSurface",Ri=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Ri)});var Y,Ci,w=i(()=>{"use strict";n();Y="pbrBlockNormalGeometric",Ci=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=Ci)});var z,mi,K=i(()=>{"use strict";n();z="pbrBlockNormalFinal",mi=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=mi)});var q,Si,Z=i(()=>{"use strict";n();q="pbrBlockLightmapInit",Si=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=Si)});var J,ui,j=i(()=>{"use strict";n();J="pbrBlockGeometryInfo",ui=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=ui)});var Q,Ai,$=i(()=>{"use strict";n();Q="pbrBlockReflectance0",Ai=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=Ai)});var ee,Ii,ie=i(()=>{"use strict";n();ee="pbrBlockReflectance",Ii=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[ee]||(e.IncludesShadersStore[ee]=Ii)});var ne,vi,ae=i(()=>{"use strict";n();ne="pbrBlockDirectLighting",vi=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[ne]||(e.IncludesShadersStore[ne]=vi)});var re,pi,oe=i(()=>{"use strict";n();re="pbrBlockFinalLitComponents",pi=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[re]||(e.IncludesShadersStore[re]=pi)});var te,Oi,fe=i(()=>{"use strict";n();te="pbrBlockFinalUnlitComponents",Oi=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStore[te]||(e.IncludesShadersStore[te]=Oi)});var ce,Ni,le=i(()=>{"use strict";n();ce="pbrBlockFinalColorComposition",Ni=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[ce]||(e.IncludesShadersStore[ce]=Ni)});var de,Ti,se=i(()=>{"use strict";n();de="pbrBlockImageProcessing",Ti=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[de]||(e.IncludesShadersStore[de]=Ti)});var Ee,Li,Re=i(()=>{"use strict";n();Ee="pbrBlockPrePass",Li=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[Ee]||(e.IncludesShadersStore[Ee]=Li)});var Ce,gi,me=i(()=>{"use strict";n();Ce="pbrDebug",gi=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Ce]||(e.IncludesShadersStore[Ce]=gi)});var a,Se,Qa,Di=i(()=>{n();pe();Oe();o();Ye();f();Ne();Te();s();_e();be();Ie();Ue();ue();R();ze();m();he();ge();we();u();I();ke();Ke();p();N();Fe();Pe();Me();L();D();_();F();b();B();y();H();W();k();Be();w();Ge();K();Ve();Z();j();$();ie();ae();He();oe();fe();le();xe();We();se();Re();Xe();me();a="pbrPixelShader",Se=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=Se);Qa={name:a,shader:Se}});export{R as a,Qa as b,Di as c};
