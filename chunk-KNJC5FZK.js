import{a as e,b as a}from"./chunk-PJTN5MCN.js";import{d as l}from"./chunk-SO6VPFYA.js";var r,o,s,t=l(()=>{a();r="bilateralBlurPixelShader",o=`uniform sampler2D textureSampler;uniform sampler2D depthSampler;uniform sampler2D normalSampler;uniform int filterSize;uniform vec2 blurDir;uniform float depthThreshold;uniform float normalThreshold;varying vec2 vUV;void main(void) {vec3 color=textureLod(textureSampler,vUV,0.).rgb;float depth=textureLod(depthSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(color,1.);return;}
...
`;e.ShadersStore[r]=o;s={name:r,shader:o}});export{s as a,t as b};
